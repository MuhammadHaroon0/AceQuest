                ...
                <div className="flex py-2 justify-between items-center">
                    <div className="flex ">
                        <div className="flex-shrink-0 flex items-center ">
                            <Link to="/">
                                <img src={logo} className=" h-16 w-48 object-contain" alt="Logo" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:block">
                        <div className="flex items-center md:ml-6 space-x-4">
                            ...
                            <div className=''>
                                {user ?
                                    <button onClick={handleLogout} className="group relative overflow-hidden border-2 border-[#1ecdf8] px-9 py-2 text-sm font-semibold text-gray-200">
                ...
                <div className="p-4 space-y-2 sm:px-3">
                    ...
                    <div className="flex flex-col space-y-2">
                        <div className="w-24 h-10">
                            {user ?
                                <button className="rounded-full py-1 hover:opacity-75 bg-primary w-full h-full text-white font-normal text-sm" onClick={handleLogout}>
                                    Logout
                                </button>
                                :
                                <Link to='/login'>
